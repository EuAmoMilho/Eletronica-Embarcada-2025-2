...
FINAL_IMAGE=${DISTDIR}/TP4_motor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TP4_motor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F886
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/TP4_motor.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/TP4_motor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F886 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/TP4_motor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
